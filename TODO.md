...
- [ ] Phase 2 Rust TUI client — remaining: event loop skeleton (Day 8), focus FSM (Day 9), Ratatui chrome (Day 10), agent.list + agent.spawn (Day 11-12), reconnect + supervisor handoff (Day 13-14).
