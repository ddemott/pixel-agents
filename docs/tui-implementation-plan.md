...
- 🟡 **Phase 1 Day 6 — Persistence ports** (next): `layoutPersistence`, `configPersistence`, `agents.json` — all tagged with `_writer` per arch §15 to break the cross-window watcher feedback loop.
