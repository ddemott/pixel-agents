...
- 🟡 **Phase 1 Day 9-10 — AgentEventSink daemon bus** (next): per-agent scope (`emitTo(agentId, ...)`) on top of the Day 7-8 broadcast; socket high-water-mark backpressure that pauses PTY pumps when a client falls behind.
